 ...
 * Used for context-aware back links (e.g., "Back to Stats" vs "Back to Home")
 */
 ...
 * Call this before navigating to a page that needs context-aware back links
 *
 ...
 * Call this when navigating back to avoid stale origin data
 */
